...
# <<< TON BLOC /account DOIT ÊTRE AU NIVEAU RACINE, PAS DANS dashboard() >>>
...
# Admin: generate pods for a round from all registered players (4 per table)
...
def confirm_submission(token, decision):
    ...
    # Ensure approver belongs to the same match & is not the submitter
    ...
    # Update leaderboard when approved
